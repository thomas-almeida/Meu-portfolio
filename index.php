...
<head>
    ...
    <link rel="shortcut icon" href="./assets/images/profile-pic.png" type="image/x-icon">
        ...
        <section class="user-post-text">
            <section class="post">
                <section class="user-post-section">
                    <img src="assets/images/profile-pic.png" id="pic-box" class="picture-box  profile-img-post" id="pic-intro" alt="">
                    <section>
            ...
            <section class="post-feed">
                ...
                <section id="post-area">
                    ...
                    <section class="post">
                        ...
                        <section class="user-post-section">
                            <img src="assets/images/profile-pic.png" class="picture-box  profile-img-post" alt="">
                            <h3 class="post-username">Thomas Almeida</b></h3>
                        </section>

                        <p class="time-posted">postado em <strong>16/10/2021 ás 03h</strong></p>

                        <h2 class="title-project">
                            Huuro - Monitor de Energia <b>novo</b>
                        </h2>

                        <p class="post-description">
                            O projeto <b>Huuro</b>, tem como foco calcular a conta de luz dos usuários, servindo como um monitor que vai mostrando o valor em R$ (real) da conta a cada nova consulta, usando de base os <b>kwh(kilo watts hora)</b> apresentados pelo usuário
                        </p>


                        <section class="github-section">
                            <h3>Acessar repositório no <a href="https://github.com/ThomAlmeidaRD/Huuro" target="_blank">Github </a>✔️</h3>
                        </section>

                        <section class="slider-caseiro">

                            <div class="img-box">
                                <img src="assets/images/huuro-1.png" draggable="false" style="width:100%">

                                <img src="assets/images/huuro-2.png" draggable="false" style="width:100%">

                                <img src="assets/images/huuro-3.png" draggable="false" style="width:100%">
                            </div>
                    ...
                    <section class="post" id="old-post-1">
                        ...
                        <h2 class="title-project">
                            Nino // Atalhos do Browser
                        </h2>

                        <p class="post-description">
                            Depois de evoluir um pouco mais usando <strong class="javascript">javascript</strong>
                            decidi tentar usar alguns recursos á mais, como local storage para salvar dados e manipular
                            strings em links a maneira que seria desafiadora seria criar uma página de atalhos e o ninno foi
                            uma ótima experiência para isso.
                        </p>
                        ...
                        <section class="slider-caseiro">
                            ...
                            <div class="img-box">
                                <img src="assets/images/nino-1.png" draggable="false" style="width:100%">

                                <img src="assets/images/nino-3.png" draggable="false" style="width:100%">

                                <img src="assets/images/nino-2.png" draggable="false" style="width:100%">
                            </div>
